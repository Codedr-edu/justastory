    ...
    <main>
        <div class="container">
            ...
            <div class="columns">
                ...
                <div class="column">
                <a href="apply.php" class="btn btn-green w-100">Cùng góp sức cho website lớn mạnh hơn</a>
                </div>
            </div>
            <?php
                if ($_SESSION["loggedin"] == true and $_SESSION["phone"]){
                    if (isset($_GET["search"])){
                        $sql = "SELECT * FROM post WHERE title='$search' or content LIKE '%$search%'";
                        ...
                        if (mysqli_num_rows($result) > 0){
                            ...
                            echo'<div class="card shadow-lg rounded">
                                    <div class="card-body">
                                        <h1 class="title is-1">Hãy thử từ khóa khác</h1>
                                    </div>
                                </div>';
                        }
                    }
