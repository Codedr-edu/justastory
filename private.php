...
<body>
    ...
    <main>
        <div class="container">
            ...
            <?php 
                ...
                if ($_SESSION["loggedin"] == true && $_SESSION["phone"]){
                    echo '<div class="columns">
                            <div class="column">
                              <h1 class="title is-1 text-start">Tất cả bài viết ẩn danh </h1>
                            </div>
                            <div class="column">
                              <p class="title is-6 text-end">Email: Ẩn</p>
                              <p class="title is-6 text-end">Điện Thoại: Ẩn</p>
                              <p class="title is-6 text-end">Lớp: Ẩn</p>
                            </div>
                          </div> ';
            ...
            <br>
                    <?php 
                        $query = "SELECT * FROM post WHERE user_id=0 ORDER BY date DESC";
                        ...
                        if(mysqli_num_rows($result) > 0) {
                          ...
                          echo' <div class="card shadow-lg rounded">
                            ...
                            echo    '<p class="text-start title is-6" style="margin-bottom:15px;">Bình Luận: '.$row['comment_counter'].'</p>
