        ...
        <div class="container">
            ...
            <div class="columns">
              ...
              <a href="security.php" class="btn btn-green w-100">Cùng phát triển website</a>
                    ...
                    if (isset($_GET['type'])){
                        $type = $_GET['type'];
                        $query = "SELECT * FROM post WHERE code=$type ORDER BY date DESC";
