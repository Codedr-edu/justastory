            ...
            <div class="d-flex aligns-items-center shadow justify-content-center card text-center w-75 mx-auto" style="margin-top: 50px;">
                <div class="card-body">
                 <div class="conatiner">
                    <div class="columns">
                        <div class="column">
                            <a href="#" class="btn btn-outline-green w-100">Đăng nhập</a>
                        </div>
                        <div class="column">
                            <a href="register.php" class="btn btn-green w-100">Đăng ký</a>
                        </div>
                      </div>
                      <h1 class="title is-1 text-center">Đăng Nhập</h1>
                      <br>
                      <form action="login.php" method="POST" enctype="multipart/form-data">
                        ...
                        <input name="submit" type="submit" class="btn btn-green shadow w-100" style="margin-top: 20px;" value="Đăng nhập">
                    </form>
                 </div>
                </div>
              </div>
